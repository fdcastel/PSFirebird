...
Describe 'GitHub releases' -Tag 'Unit' {
    InModuleScope 'PSFirebird' {
        ...
        It 'Returns release info for Firebird 6.x' {
            $result = Find-FirebirdRelease -Version '6.0.0' -RuntimeIdentifier 'win-x64'
        ...
        It 'Returns release info for Firebird 5.x' {
            $result = Find-FirebirdRelease -Version '5.0.2' -RuntimeIdentifier 'win-x64'
        ...
        It 'Returns Sha256 when digest field is available (v6.0.0)' {
            $result = Find-FirebirdRelease -Version '6.0.0' -RuntimeIdentifier 'linux-x64'
        ...
        It 'Returns null Sha256 when digest field is not available (v4.0.5)' {
            $result = Find-FirebirdRelease -Version '4.0.5' -RuntimeIdentifier 'linux-x64'
